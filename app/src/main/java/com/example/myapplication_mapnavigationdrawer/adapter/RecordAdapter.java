...
public class RecordAdapter extends ArrayAdapter<String> {
    ...
    private ArrayList<String> web_record_parkinglot_time, web_txt_is_finish, web_txt_is_using, web_record_parkinglot_name,
    ...
    public RecordAdapter(Activity context,
                         ...
                         ArrayList<String> web_record_parkinglot_name, ArrayList<String> web_parking_total_time, ArrayList<String> web_record_parkinglot_address,
